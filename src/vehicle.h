...
#ifndef CARND_PATH_PLANNING_PROJECT_VEHICLE_H
#define CARND_PATH_PLANNING_PROJECT_VEHICLE_H
...
class Vehicle {
 public:
  // Constructors
  Vehicle();
  Vehicle(int lane, float s, float speed, float accel, string state="CS");
...
#endif //CARND_PATH_PLANNING_PROJECT_VEHICLE_H
